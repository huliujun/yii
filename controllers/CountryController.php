...
class CountryController extends Controller
{
    ...
    public function actionUpload() {
       ...
       // var_dump($currentSheet);
        ...
        //$currentSheet->getStyle('A2:A6')->getNumberFormat()->setFormatCode('yyyy-mm-dd');

        $message1 = $currentSheet->toArray('', true, true);
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('upload', ['message1'=> $message1,'model' => $model,]);
        }
